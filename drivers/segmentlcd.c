...
typedef struct
{
  uint8_t com[12]; /**< LCD COM line (for multiplexing) */
  uint8_t bit[12]; /**< LCD bit number */
} POWERMETER_TypeDef;
...
typedef struct
{
  ...
  NUMBER_TypeDef  		Number[4];    /**< Numbers on display */
	BATTERY_TypeDef			Battery;			/**< Battery bar on display */
  POWERMETER_TypeDef	PowerMeter;		/**< Powermeter on display */
  ARROWS_TypeDef			Arrows;				/**< Arrows on display */
} MCU_DISPLAY;
...
/**************************************************************************//**
 * @brief Light up or shut off Arrows indicator
 * @param arrow Arrows numer 0 to 4
...
// NOT AVAILABLE ON OLIMEX DISPLAY!
// /**************************************************************************//**
...
void SegmentLCD_Symbol(lcdSymbol s, int on)
{
  ...
  switch (s)
  {
    ...
    com = LCD_SYMBOL_OLIMEX_COM;
		bit = LCD_SYMBOL_OLIMEX_SEG;
    break;
  case LCD_SYMBOL_ARR_UP:
    com = LCD_SYMBOL_ARR_UP_COM;
		bit = LCD_SYMBOL_ARR_UP_SEG;
    break;
  case LCD_SYMBOL_ARR_DN:
    com = LCD_SYMBOL_ARR_DN_COM;
		bit = LCD_SYMBOL_ARR_DN_SEG;
    break;
  case LCD_SYMBOL_ARR_L:
    com = LCD_SYMBOL_ARR_L_COM;
		bit = LCD_SYMBOL_ARR_L_SEG;
    break;
  case LCD_SYMBOL_ARR_R:
    com = LCD_SYMBOL_ARR_R_COM; 
		bit = LCD_SYMBOL_ARR_R_SEG;
    break;
  ...
  case LCD_SYMBOL_PLUS:
    com = LCD_SYMBOL_PLUS_COM; 
		bit = LCD_SYMBOL_PLUS_SEG;
    break;
  case LCD_SYMBOL_u:
    com = LCD_SYMBOL_u_COM; 
		bit = LCD_SYMBOL_u_SEG;
    break;
  case LCD_SYMBOL_m:
    com = LCD_SYMBOL_m_COM; 
		bit = LCD_SYMBOL_m_SEG;
    break;
  case LCD_SYMBOL_H:
    com = LCD_SYMBOL_H_COM; 
		bit = LCD_SYMBOL_H_SEG;
    break;
  case LCD_SYMBOL_F:
    com = LCD_SYMBOL_F_COM; 
		bit = LCD_SYMBOL_F_SEG;
    break;
	case LCD_SYMBOL_2COL:
    com = LCD_SYMBOL_2COL_COM; 
		bit = LCD_SYMBOL_2COL_SEG;
    break;
	case LCD_SYMBOL_3COL:
    com = LCD_SYMBOL_3COL_COM; 
		bit = LCD_SYMBOL_3COL_SEG;
    break;
	case LCD_SYMBOL_4COL:
    com = LCD_SYMBOL_4COL_COM; 
		bit = LCD_SYMBOL_4COL_SEG;
    break;
	case LCD_SYMBOL_5COL:
    com = LCD_SYMBOL_5COL_COM; 
		bit = LCD_SYMBOL_5COL_SEG;
    break;
	case LCD_SYMBOL_6COL:
    com = LCD_SYMBOL_6COL_COM; 
		bit = LCD_SYMBOL_6COL_SEG;
    break;
  case LCD_SYMBOL_10COL:
    com = LCD_SYMBOL_10COL_COM; 
		bit = LCD_SYMBOL_10COL_SEG;
    break;
	case LCD_SYMBOL_1DP:
    com = LCD_SYMBOL_1DP_COM; 
		bit = LCD_SYMBOL_1DP_SEG;
    break;
	case LCD_SYMBOL_2DP:
    com = LCD_SYMBOL_2DP_COM; 
		bit = LCD_SYMBOL_2DP_SEG;
    break;
	case LCD_SYMBOL_3DP:
    com = LCD_SYMBOL_3DP_COM; 
		bit = LCD_SYMBOL_3DP_SEG;
    break;
	case LCD_SYMBOL_4DP:
    com = LCD_SYMBOL_4DP_COM; 
		bit = LCD_SYMBOL_4DP_SEG;
    break;			 
	case LCD_SYMBOL_5DP:
    com = LCD_SYMBOL_5DP_COM; 
		bit = LCD_SYMBOL_5DP_SEG;
    break;
	case LCD_SYMBOL_6DP:
    com = LCD_SYMBOL_6DP_COM; 
		bit = LCD_SYMBOL_6DP_SEG;
    break;
	case LCD_SYMBOL_8DP:
    com = LCD_SYMBOL_8DP_COM; 
		bit = LCD_SYMBOL_8DP_SEG;
    break;
	case LCD_SYMBOL_10DP:
    com = LCD_SYMBOL_10DP_COM; 
		bit = LCD_SYMBOL_10DP_SEG;
    break;
	case LCD_SYMBOL_11DP:
    com = LCD_SYMBOL_11DP_COM; 
		bit = LCD_SYMBOL_11DP_SEG;
    break;
  }
  if (on)
  {
