# 1 "..\\..\\EFM32G\\Source\\system_efm32g.c"
...
#define DEBUG_EFM 1
# 1 "..\\..\\EFM32G\\Source\\system_efm32g.c"
# 34 "..\\..\\EFM32G\\Source\\system_efm32g.c"
...
# 35 "..\\..\\EFM32G\\Source\\system_efm32g.c" 2
...
# 36 "..\\..\\EFM32G\\Source\\system_efm32g.c" 2
...
# 61 "..\\..\\EFM32G\\Source\\system_efm32g.c"
...
static uint32_t SystemHFXOClock = (32000000UL);
...
# 101 "..\\..\\EFM32G\\Source\\system_efm32g.c"
uint32_t SystemCoreClock;
# 124 "..\\..\\EFM32G\\Source\\system_efm32g.c"
uint32_t SystemCoreClockGet(void)
{
  uint32_t ret;
  ...
  ret >>= (((CMU_TypeDef *) (0x400C8000UL))->HFCORECLKDIV & 0xFUL) >>
          0;
...
# 153 "..\\..\\EFM32G\\Source\\system_efm32g.c"
uint32_t SystemHFClockGet(void)
{
  uint32_t ret;
                         ...
                         (0x1UL << 12) | (0x1UL << 13)))
  {
    ...
    default:
      switch (((CMU_TypeDef *) (0x400C8000UL))->HFRCOCTRL & 0x700UL)
      {
      case (0x00000005UL << 8):
        ret = 28000000;
        break;
...
# 238 "..\\..\\EFM32G\\Source\\system_efm32g.c"
uint32_t SystemHFXOClockGet(void)
{
...
# 264 "..\\..\\EFM32G\\Source\\system_efm32g.c"
void SystemHFXOClockSet(uint32_t freq)
{
  ...
  if (((CMU_TypeDef *) (0x400C8000UL))->STATUS & (0x1UL << 11))
  {
...
# 294 "..\\..\\EFM32G\\Source\\system_efm32g.c"
void SystemInit(void)
{
}
# 309 "..\\..\\EFM32G\\Source\\system_efm32g.c"
uint32_t SystemLFRCOClockGet(void)
{
...
# 328 "..\\..\\EFM32G\\Source\\system_efm32g.c"
uint32_t SystemULFRCOClockGet(void)
{

  return (1000UL);
}
# 345 "..\\..\\EFM32G\\Source\\system_efm32g.c"
uint32_t SystemLFXOClockGet(void)
{
...
# 371 "..\\..\\EFM32G\\Source\\system_efm32g.c"
void SystemLFXOClockSet(uint32_t freq)
{
  ...
  if (((CMU_TypeDef *) (0x400C8000UL))->STATUS & (0x1UL << 13))
  {
