...
# 36 "..\\..\\emlib\\src\\em_system.c" 2
# 59 "..\\..\\emlib\\src\\em_system.c"
void SYSTEM_ChipRevisionGet(SYSTEM_ChipRevision_TypeDef *rev)
{
  uint8_t tmp;

  ((rev) ? ((void)0) : assertEFM("..\\..\\emlib\\src\\em_system.c", 63));

  rev->major = (((ROMTABLE_TypeDef *) (0xE00FFFD0UL))->PID0 & 0x0000003FUL) >> 0;

  tmp = (((ROMTABLE_TypeDef *) (0xE00FFFD0UL))->PID2 & 0x000000F0UL);
  tmp |= ((((ROMTABLE_TypeDef *) (0xE00FFFD0UL))->PID3 & 0x000000F0UL) >> 4);
  rev->minor = tmp;
}
...
uint32_t SYSTEM_GetCalibrationValue(volatile uint32_t *regAddress)
{
  ...
  regCount = 1;
  p = ((CALIBRATE_TypeDef *) (0x0FE08000UL));
  ...
  for (;; )
  {
    if ((regCount > 50) ||
        (p->VALUE == 0xFFFFFFFF))
    {
      ((0) ? ((void)0) : assertEFM("..\\..\\emlib\\src\\em_system.c", 95));
      return 0;
    }
