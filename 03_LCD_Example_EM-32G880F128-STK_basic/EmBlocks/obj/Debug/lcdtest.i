...
# 11 "c:\\program files (x86)\\emblocks\\2.00\\share\\em_armgcc\\bin\\../lib/gcc/arm-none-eabi/4.7.3/../../../../arm-none-eabi/include/string.h" 2 3
...
# 12 "c:\\program files (x86)\\emblocks\\2.00\\share\\em_armgcc\\bin\\../lib/gcc/arm-none-eabi/4.7.3/../../../../arm-none-eabi/include/string.h" 2 3
...
# 39 "..\\lcdtest.c" 2
# 1 "..\\..\\emlib\\inc/em_emu.h" 1
# 34 "..\\..\\emlib\\inc/em_emu.h"
#define __EM_EMU_H 
...
# 39 "..\\..\\emlib\\inc/em_emu.h" 2
# 201 "..\\..\\emlib\\inc/em_emu.h"
...
{
  BITBAND_Peripheral(&(((EMU_TypeDef *) (0x400C6000UL))->CTRL), 1, 1U);
}
...
{
  BITBAND_Peripheral(&(((EMU_TypeDef *) (0x400C6000UL))->CTRL), 1, 0U);
}
# 40 "..\\lcdtest.c" 2
...
# 46 "..\\..\\drivers/segmentlcdconfig_olimex.h"
typedef enum
{
 LCD_SYMBOL_OLIMEX,
...
# 45 "..\\lcdtest.c" 2
# 1 "..\\..\\drivers/rtcdrv.h" 1
# 36 "..\\..\\drivers/rtcdrv.h"
#define __RTCDRV_H 
# 55 "..\\..\\drivers/rtcdrv.h"
void RTCDRV_Delay(uint32_t msec, _Bool useEM2);
...
static uint16_t emMode = 0x0;
static _Bool inEM3 = 0;
...
void GPIO_IRQInit(void)
{
 ...
 GPIO_PinModeSet(gpioPortE,1,gpioModeInputPullFilter,1);
  ...
  GPIO_IntConfig(gpioPortE, 0, 0, 1, 1);


  GPIO_IntConfig(gpioPortE, 1, 0, 1, 1);
}
...
void Test(void)
{
  ...
  while (1)
  {
   ...
   SegmentLCD_Arrows(0, 1);
      ...
      EM3Sleep();
   SegmentLCD_Battery(0);
   SegmentLCD_Arrows(0, 0);
   SegmentLCD_Arrows(2, 1);
   SegmentLCD_Write("wakeup");
   RTCDRV_Delay(1500, 0);
   SegmentLCD_Arrows(2, 0);
      SegmentLCD_Battery(0);
