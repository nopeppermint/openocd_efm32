...
# 35 "..\\..\\emlib\\src\\em_gpio.c" 2
# 1 "..\\..\\emlib\\inc/em_bitband.h" 1
# 36 "..\\..\\emlib\\src\\em_gpio.c" 2
# 1 "..\\..\\emlib\\inc/em_assert.h" 1
# 37 "..\\..\\emlib\\src\\em_gpio.c" 2
# 56 "..\\..\\emlib\\src\\em_gpio.c"
#define GPIO_DRIVEMODE_VALID(mode) ((mode) <= 3)
# 75 "..\\..\\emlib\\src\\em_gpio.c"
void GPIO_DbgLocationSet(unsigned int location)
{
  ((location < 4) ? ((void)0) : assertEFM("..\\..\\emlib\\src\\em_gpio.c", 77));

  ((GPIO_TypeDef *) (0x40006000UL))->ROUTE = (((GPIO_TypeDef *) (0x40006000UL))->ROUTE & ~0x300UL) |
                (location << 8);
}
# 94 "..\\..\\emlib\\src\\em_gpio.c"
void GPIO_DriveModeSet(GPIO_Port_TypeDef port, GPIO_DriveMode_TypeDef mode)
{
  ((((port) <= gpioPortF) && ((mode) <= 3)) ? ((void)0) : assertEFM("..\\..\\emlib\\src\\em_gpio.c", 96));

  ((GPIO_TypeDef *) (0x40006000UL))->P[port].CTRL = (((GPIO_TypeDef *) (0x40006000UL))->P[port].CTRL & ~(0x3UL))
                       | (mode << 0);
}
# 139 "..\\..\\emlib\\src\\em_gpio.c"
void GPIO_IntConfig(GPIO_Port_TypeDef port,
                    unsigned int pin,
                    _Bool risingEdge,
                    _Bool fallingEdge,
                    _Bool enable)
{
  ...
  ((((port) <= gpioPortF) && ((pin) < 16)) ? ((void)0) : assertEFM("..\\..\\emlib\\src\\em_gpio.c", 147));
  ...
  if (pin < 8)
  {
    ((GPIO_TypeDef *) (0x40006000UL))->EXTIPSELL = (((GPIO_TypeDef *) (0x40006000UL))->EXTIPSELL & ~(0xF << (4 * pin))) |
                      (port << (4 * pin));
  }
  else
  {
    tmp = pin - 8;
    ((GPIO_TypeDef *) (0x40006000UL))->EXTIPSELH = (((GPIO_TypeDef *) (0x40006000UL))->EXTIPSELH & ~(0xF << (4 * tmp))) |
                      (port << (4 * tmp));
  }


  BITBAND_Peripheral(&(((GPIO_TypeDef *) (0x40006000UL))->EXTIRISE), pin, (unsigned int)risingEdge);


  BITBAND_Peripheral(&(((GPIO_TypeDef *) (0x40006000UL))->EXTIFALL), pin, (unsigned int)fallingEdge);


  ((GPIO_TypeDef *) (0x40006000UL))->IFC = 1 << pin;


  BITBAND_Peripheral(&(((GPIO_TypeDef *) (0x40006000UL))->IEN), pin, (unsigned int)enable);
}
# 195 "..\\..\\emlib\\src\\em_gpio.c"
void GPIO_PinModeSet(GPIO_Port_TypeDef port,
                     unsigned int pin,
                     GPIO_Mode_TypeDef mode,
                     unsigned int out)
{
  ((((port) <= gpioPortF) && ((pin) < 16)) ? ((void)0) : assertEFM("..\\..\\emlib\\src\\em_gpio.c", 200));
  ...
  if (pin < 8)
  {
    ((GPIO_TypeDef *) (0x40006000UL))->P[port].MODEL = (((GPIO_TypeDef *) (0x40006000UL))->P[port].MODEL & ~(0xF << (pin * 4))) |
                          (mode << (pin * 4));
  }
  else
  {
    ((GPIO_TypeDef *) (0x40006000UL))->P[port].MODEH = (((GPIO_TypeDef *) (0x40006000UL))->P[port].MODEH & ~(0xF << ((pin - 8) * 4))) |
                          (mode << ((pin - 8) * 4));
  }
