...
# 36 "..\\..\\emlib\\src\\em_emu.c" 2
# 77 "..\\..\\emlib\\src\\em_emu.c"
static uint16_t cmuStatus;
# 91 "..\\..\\emlib\\src\\em_emu.c"
static void EMU_Restore(void)
{
  ...
  ((CMU_TypeDef *) (0x400C8000UL))->OSCENCMD = cmuStatus & ((0x1UL << 4) |
                               (0x1UL << 2) |
                               (0x1UL << 6) |
                               (0x1UL << 8));


  switch (cmuStatus & ((0x1UL << 11) | (0x1UL << 10) |
                       (0x1UL << 13) | (0x1UL << 12)))
  {
  case (0x1UL << 12):

    while (!(((CMU_TypeDef *) (0x400C8000UL))->STATUS & (0x1UL << 7)))
      ;
    ((CMU_TypeDef *) (0x400C8000UL))->CMD = (0x00000003UL << 0);
    break;

  case (0x1UL << 13):

    while (!(((CMU_TypeDef *) (0x400C8000UL))->STATUS & (0x1UL << 9)))
      ;
    ((CMU_TypeDef *) (0x400C8000UL))->CMD = (0x00000004UL << 0);
    break;

  case (0x1UL << 11):

    while (!(((CMU_TypeDef *) (0x400C8000UL))->STATUS & (0x1UL << 3)))
      ;
    ((CMU_TypeDef *) (0x400C8000UL))->CMD = (0x00000002UL << 0);
    break;
...
# 204 "..\\..\\emlib\\src\\em_emu.c"
void EMU_EnterEM2(_Bool restore)
{


  cmuStatus = (uint16_t)(((CMU_TypeDef *) (0x400C8000UL))->STATUS);
  ...
  else if (!(cmuStatus & (0x1UL << 10)))
  {
    SystemCoreClockUpdate();
  }
}
# 271 "..\\..\\emlib\\src\\em_emu.c"
void EMU_EnterEM3(_Bool restore)
{
  uint32_t cmuLocked;
...
void EMU_EnterEM4(void)
{
  ...
  for (i = 0; i < 4; i++)
  {
    ((EMU_TypeDef *) (0x400C6000UL))->CTRL = (2 << 2);
    ((EMU_TypeDef *) (0x400C6000UL))->CTRL = (3 << 2);
  }
  ((EMU_TypeDef *) (0x400C6000UL))->CTRL = (2 << 2);
}
# 349 "..\\..\\emlib\\src\\em_emu.c"
void EMU_MemPwrDown(uint32_t blocks)
{

  ((blocks <= 0x00000007UL) ? ((void)0) : assertEFM("..\\..\\emlib\\src\\em_emu.c", 352));

  ((EMU_TypeDef *) (0x400C6000UL))->MEMCTRL = blocks;



}
# 380 "..\\..\\emlib\\src\\em_emu.c"
void EMU_UpdateOscConfig(void)
{
