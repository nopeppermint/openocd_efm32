...
# 37 "..\\..\\emlib\\src\\em_lcd.c" 2
# 62 "..\\..\\emlib\\src\\em_lcd.c"
void LCD_Init(const LCD_Init_TypeDef *lcdInit)
{
  uint32_t dispCtrl = ((LCD_TypeDef *) (0x4008A000UL))->DISPCTRL;

  ((lcdInit != (void *) 0) ? ((void)0) : assertEFM("..\\..\\emlib\\src\\em_lcd.c", 66));
  ...
  ((LCD_TypeDef *) (0x4008A000UL))->DISPCTRL = dispCtrl;
...
void LCD_VLCDSelect(LCD_VLCDSel_TypeDef vlcd)
{
  ...
  case lcdVLCDSelVExtBoost:
    dispctrl |= (0x00000001UL << 16);
    break;
  case lcdVLCDSelVDD:
    dispctrl |= (0x00000000UL << 16);
    break;
  default:
    break;
  }
...
# 136 "..\\..\\emlib\\src\\em_lcd.c"
void LCD_UpdateCtrl(LCD_UpdateCtrl_TypeDef ud)
{
  ((LCD_TypeDef *) (0x4008A000UL))->CTRL = (((LCD_TypeDef *) (0x4008A000UL))->CTRL & ~0x6UL) | ud;
}
# 149 "..\\..\\emlib\\src\\em_lcd.c"
void LCD_FrameCountInit(const LCD_FrameCountInit_TypeDef *fcInit)
{
  uint32_t bactrl = ((LCD_TypeDef *) (0x4008A000UL))->BACTRL;

  ((fcInit != (void *) 0) ? ((void)0) : assertEFM("..\\..\\emlib\\src\\em_lcd.c", 153));


  ((fcInit->top < 64) ? ((void)0) : assertEFM("..\\..\\emlib\\src\\em_lcd.c", 156));


  bactrl &= ~(0xFC0000UL |
              0x30000UL);
  bactrl |= (fcInit->top << 18);
  bactrl |= fcInit->prescale;


  ((LCD_TypeDef *) (0x4008A000UL))->BACTRL = bactrl;

  LCD_FrameCountEnable(fcInit->enable);
}
# 178 "..\\..\\emlib\\src\\em_lcd.c"
void LCD_AnimInit(const LCD_AnimInit_TypeDef *animInit)
{
  uint32_t bactrl = ((LCD_TypeDef *) (0x4008A000UL))->BACTRL;

  ((animInit != (void *) 0) ? ((void)0) : assertEFM("..\\..\\emlib\\src\\em_lcd.c", 182));


  ((LCD_TypeDef *) (0x4008A000UL))->AREGA = animInit->AReg;
  ((LCD_TypeDef *) (0x4008A000UL))->AREGB = animInit->BReg;
  ...
  bactrl |= (animInit->AShift << 3);
  bactrl |= (animInit->BShift << 5);
  bactrl |= animInit->animLogic;
# 211 "..\\..\\emlib\\src\\em_lcd.c"
  ((LCD_TypeDef *) (0x4008A000UL))->BACTRL = bactrl;


  LCD_AnimEnable(animInit->enable);
}
# 229 "..\\..\\emlib\\src\\em_lcd.c"
void LCD_SegmentRangeEnable(LCD_SegmentRange_TypeDef segmentRange, _Bool enable)
{
  if (enable)
  {
    ((LCD_TypeDef *) (0x4008A000UL))->SEGEN |= segmentRange;
  }
  else
  {
    ((LCD_TypeDef *) (0x4008A000UL))->SEGEN &= ~((uint32_t)segmentRange);
  }
}
# 260 "..\\..\\emlib\\src\\em_lcd.c"
void LCD_SegmentSet(int com, int bit, _Bool enable)
{
  ...
  ((com < 4) ? ((void)0) : assertEFM("..\\..\\emlib\\src\\em_lcd.c", 267));



  ((bit < 40) ? ((void)0) : assertEFM("..\\..\\emlib\\src\\em_lcd.c", 271));
  ...
  case 0:
    if (bit < 32)
    {
      BITBAND_Peripheral(&(((LCD_TypeDef *) (0x4008A000UL))->SEGD0L), bit, (unsigned int)enable);
    }

    else
    {
      bit -= 32;
      BITBAND_Peripheral(&(((LCD_TypeDef *) (0x4008A000UL))->SEGD0H), bit, (unsigned int)enable);
    }
  ...
  case 1:
    if (bit < 32)
    {
      BITBAND_Peripheral(&(((LCD_TypeDef *) (0x4008A000UL))->SEGD1L), bit, (unsigned int)enable);
    }

    else
    {
      bit -= 32;
      BITBAND_Peripheral(&(((LCD_TypeDef *) (0x4008A000UL))->SEGD1H), bit, (unsigned int)enable);
    }
  ...
  case 2:
    if (bit < 32)
    {
      BITBAND_Peripheral(&(((LCD_TypeDef *) (0x4008A000UL))->SEGD2L), bit, (unsigned int)enable);
    }

    else
    {
      bit -= 32;
      BITBAND_Peripheral(&(((LCD_TypeDef *) (0x4008A000UL))->SEGD2H), bit, (unsigned int)enable);
    }
  ...
  case 3:
    if (bit < 32)
    {
      BITBAND_Peripheral(&(((LCD_TypeDef *) (0x4008A000UL))->SEGD3L), bit, (unsigned int)enable);
    }

    else
    {
      bit -= 32;
      BITBAND_Peripheral(&(((LCD_TypeDef *) (0x4008A000UL))->SEGD3H), bit, (unsigned int)enable);
    }

    break;
  case 4:
# 346 "..\\..\\emlib\\src\\em_lcd.c"
    break;
  case 5:
# 361 "..\\..\\emlib\\src\\em_lcd.c"
    break;
  case 6:
# 376 "..\\..\\emlib\\src\\em_lcd.c"
    break;
  case 7:
# 391 "..\\..\\emlib\\src\\em_lcd.c"
    break;

  default:
    ((0) ? ((void)0) : assertEFM("..\\..\\emlib\\src\\em_lcd.c", 394));
    break;
  }
}
# 414 "..\\..\\emlib\\src\\em_lcd.c"
void LCD_SegmentSetLow(int com, uint32_t mask, uint32_t bits)
{
  uint32_t segData;
  ...
  ((com < 4) ? ((void)0) : assertEFM("..\\..\\emlib\\src\\em_lcd.c", 423));


  switch (com)
  {
  case 0:
    segData = ((LCD_TypeDef *) (0x4008A000UL))->SEGD0L;
    segData &= ~(mask);
    segData |= (mask & bits);
    ((LCD_TypeDef *) (0x4008A000UL))->SEGD0L = segData;
    break;
  case 1:
    segData = ((LCD_TypeDef *) (0x4008A000UL))->SEGD1L;
    segData &= ~(mask);
    segData |= (mask & bits);
    ((LCD_TypeDef *) (0x4008A000UL))->SEGD1L = segData;
    break;
  case 2:
    segData = ((LCD_TypeDef *) (0x4008A000UL))->SEGD2L;
    segData &= ~(mask);
    segData |= (mask & bits);
    ((LCD_TypeDef *) (0x4008A000UL))->SEGD2L = segData;
    break;
  case 3:
    segData = ((LCD_TypeDef *) (0x4008A000UL))->SEGD3L;
    segData &= ~(mask);
    segData |= (mask & bits);
    ((LCD_TypeDef *) (0x4008A000UL))->SEGD3L = segData;
    break;
# 484 "..\\..\\emlib\\src\\em_lcd.c"
  default:
    ((0) ? ((void)0) : assertEFM("..\\..\\emlib\\src\\em_lcd.c", 485));
    break;
  }
}
# 505 "..\\..\\emlib\\src\\em_lcd.c"
void LCD_SegmentSetHigh(int com, uint32_t mask, uint32_t bits)
{
  uint32_t segData;
  ...
  ((com < 4) ? ((void)0) : assertEFM("..\\..\\emlib\\src\\em_lcd.c", 513));
  ...
  {
  case 0:
    segData = ((LCD_TypeDef *) (0x4008A000UL))->SEGD0H;
    segData &= ~(mask);
    segData |= (mask & bits);
    ((LCD_TypeDef *) (0x4008A000UL))->SEGD0H = segData;
    break;
  case 1:
    segData = ((LCD_TypeDef *) (0x4008A000UL))->SEGD1H;
    segData &= ~(mask);
    segData |= (mask & bits);
    ((LCD_TypeDef *) (0x4008A000UL))->SEGD1H = segData;
    break;
  case 2:
    segData = ((LCD_TypeDef *) (0x4008A000UL))->SEGD2H;
    segData &= ~(mask);
    segData |= (mask & bits);
    ((LCD_TypeDef *) (0x4008A000UL))->SEGD2H = segData;
    break;
  case 3:
    segData = ((LCD_TypeDef *) (0x4008A000UL))->SEGD3H;
    segData &= ~(mask);
    segData |= (mask & bits);
    ((LCD_TypeDef *) (0x4008A000UL))->SEGD3H = segData;
    break;
# 575 "..\\..\\emlib\\src\\em_lcd.c"
  default:
    break;
  }
}
# 588 "..\\..\\emlib\\src\\em_lcd.c"
void LCD_ContrastSet(int level)
{
  ((level < 32) ? ((void)0) : assertEFM("..\\..\\emlib\\src\\em_lcd.c", 590));

  ((LCD_TypeDef *) (0x4008A000UL))->DISPCTRL = (((LCD_TypeDef *) (0x4008A000UL))->DISPCTRL & ~0x1F00UL)
                  | (level << 8);
}
# 606 "..\\..\\emlib\\src\\em_lcd.c"
void LCD_VBoostSet(LCD_VBoostLevel_TypeDef vboost)
{

  ((LCD_TypeDef *) (0x4008A000UL))->DISPCTRL = (((LCD_TypeDef *) (0x4008A000UL))->DISPCTRL & ~0x1C0000UL) | vboost;
}
