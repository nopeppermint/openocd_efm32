...
# 40 "..\\..\\drivers\\rtcdrv.c" 2
# 1 "..\\..\\emlib\\inc/em_rtc.h" 1
# 34 "..\\..\\emlib\\inc/em_rtc.h"
#define __EM_RTC_H 
...
# 42 "..\\..\\drivers\\rtcdrv.c" 2

static void (*rtcCb)(void);
static uint8_t rtcInitialized = 0;
static volatile _Bool rtcDelayComplete;
...
void RTC_IRQHandler(void)
{
  ...
  RTC_IntClear((0x1UL << 1));


  RTC_IntDisable((0x1UL << 1));
...
void RTCDRV_Trigger(uint32_t msec, void (*cb)(void))
{
  ...
  if (!rtcInitialized)
  {
    ...
    RTCDRV_Setup(cmuSelect_LFRCO, 32);
  }
